...
- Appears in the background cast attached to Crusade command structures.
- Reflects the human command layer that coexists uneasily with transhuman Legion agendas.
- Recorded as supporting continuity rather than a central narrative actor.

## 🔗 Connections
- Connected to the same Imperial command thread as [[Heresy_Omnibus/Characters/Coraline Asenec]].
- Present in the broader campaign arc dominated by [[Heresy_Omnibus/Characters/Fulgrim]], [[Heresy_Omnibus/Characters/Eidolon]], and [[Heresy_Omnibus/Characters/Fabius Bile]].
...
## 🏷︎ Tags
#EvanderTobias #ImperialCommand #HorusHeresy
